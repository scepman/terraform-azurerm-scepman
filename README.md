...
| <a name="input_law_workspace_id"></a> [law\_workspace\_id](#input\_law\_workspace\_id)                                                              | Workspace ID of the existing log analytics workspace                      | `string`      | `null`                                                                                                |    no    |
| <a name="input_law_shared_key"></a> [law\_shared\_key](#input\_law\_shared\_key)                                                                    | Primary or secondary shared Key for exisiting log analytics workspace     | `string`      | `null`                                                                                                |    no    |
